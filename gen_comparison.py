...
columns = [
  ...
  ('F2A02','f1516_f2.csv','Total Assets'),
  ('F2A03','f1516_f2.csv','Total Liabilities'),
  ('F2A03A','f1516_f2.csv','Debt related to Property, Plant, and Equipment'),
  ('F2A17','f1516_f2.csv','Total Plant, Property, and Equipment'),
  ('F2A18','f1516_f2.csv','Accumulated Depreciation'),
  ('F2B01','f1516_f2.csv','Total Revenue'),
  ('F2B02','f1516_f2.csv','Total Expenses'),
  ('F2B04','f1516_f2.csv','Total change in net assets'),
  ('F2C05','f1516_f2.csv','Institutional Grants (funded)'),
  ('F2C06','f1516_f2.csv','Institutional Grants (unfunded)'),
  ('F2C07','f1516_f2.csv','Total Student Grants'),
  ('F2C10','f1516_f2.csv','Total Allowances and Discounts'),
  ('F2D01','f1516_f2.csv','Total Tuition and Fees'),
  ('F2D08','f1516_f2.csv','Private gifts and grants'),
  ('F2D10','f1516_f2.csv','Investment return'),
  ('F2D16','f1516_f2.csv','Total Revenue and Investment return'),
]
