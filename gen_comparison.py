...
columns = [
  ...
  ('SANIN01','sal2016_nis.csv','Full-time non-instructional staff - number'),
  ('SANIT01','sal2016_nis.csv','Full-time non-instructional staff - outlays'),
  ('SAINSTT','sal2016_is.csv','Instructional staff - number'),
  ('SAOUTLT','sal2016_is.csv','Instructional staff - outlays'),
  ('APPLCN','adm{y}.csv','Total Applicants'),
  ('ADMSSN','adm{y}.csv','Total Admitted'),
  ('ENRLT','adm{y}.csv','Total Enrolled'),
  ('SATVR25','adm{y}.csv','SAT Reading 25th percentile'),
...
academic_years = ['0506', '0607', '0708', '0809', '0910', '1011', '1112', '1213', '1314', '1415', '1516','1617']
